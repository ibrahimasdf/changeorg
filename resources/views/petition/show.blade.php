...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="box box-widget">
            ...
            <div class="box-body">
                <h4><strong>Bookmarksgrove</strong></h4>
...
@if(\Illuminate\Support\Facades\Auth::check())
        <div class="pull-right">
            <div class="btn-group">
                <a href="{{url('petitions/'. $petitions->id.  '/edit')}}" type="button" class="btn btn-warning">Edit</a>
        ...
        @endif
        <form id="delete-petition" method="post" action ="{{url('petitions/'.$petitions->id)}}">
            {{csrf_field()}}
            {{method_field('delete')}}
        </form>
